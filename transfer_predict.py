# train 2d slice model
# from hema_exp.predict import predict
...
from hema_exp.predict_monai import predict
import argparse

    
def main():
    # set parameter
    #config_path = "checkpoints/transfer_yaml_template/predict/cohort_b/cohort_b_syn100_model.yaml"
    config_path = "configs/transfer/batch_predict/cohort_b/predict_cohort_b_syn100_cohort_a_aug_bal_fold_0_r01.yaml"
